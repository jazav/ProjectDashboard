...
def get_domain_bssbox(component):
    return {
        ...
        'DevOps': 'DevOps',
        'DFE': 'DFE',
        'Digital API': 'CRM (Customer Relationship Management)',
        ...
        'Ordering Arch & SA': 'Order Management & Partner Management',
        ...
        'Partners Arch & SA': 'Order Management & Partner Management',
        'Party Management': 'CRM',
        'Payment Management': 'Payment Management',
        'Pays Arch & SA': 'Payment Management',
